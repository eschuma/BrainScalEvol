...
## SS Model, Hypothesis Ampullary
## k = 4 shifts
## mormyroid+notopterid sb = 99
## teleost sb = 1735
## gymnote sb = 164
## silurid sb = 161

k <- 4
sb <- c(1735, 99, 164, 161)
...
fixed.mcmc.SS.351 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.351$model, prior=prior.fixed.SS, startpar=model.fixed.SS.351$startpar, file.dir=getwd(), outname="AMPfixedSS_r351", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.352 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.352$model, prior=prior.fixed.SS, startpar=model.fixed.SS.352$startpar, file.dir=getwd(), outname="AMPfixedSS_r352", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.353 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.353$model, prior=prior.fixed.SS, startpar=model.fixed.SS.353$startpar, file.dir=getwd(), outname="AMPfixedSS_r353", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.354 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.354$model, prior=prior.fixed.SS, startpar=model.fixed.SS.354$startpar, file.dir=getwd(), outname="AMPfixedSS_r354", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.355 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.355$model, prior=prior.fixed.SS, startpar=model.fixed.SS.355$startpar, file.dir=getwd(), outname="AMPfixedSS_r355", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.356 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.356$model, prior=prior.fixed.SS, startpar=model.fixed.SS.356$startpar, file.dir=getwd(), outname="AMPfixedSS_r356", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.357 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.357$model, prior=prior.fixed.SS, startpar=model.fixed.SS.357$startpar, file.dir=getwd(), outname="AMPfixedSS_r357", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.358 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.358$model, prior=prior.fixed.SS, startpar=model.fixed.SS.358$startpar, file.dir=getwd(), outname="AMPfixedSS_r358", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.359 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.359$model, prior=prior.fixed.SS, startpar=model.fixed.SS.359$startpar, file.dir=getwd(), outname="AMPfixedSS_r359", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.360 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.360$model, prior=prior.fixed.SS, startpar=model.fixed.SS.360$startpar, file.dir=getwd(), outname="AMPfixedSS_r360", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
#pdf("AMPfixedSS.350s_trace_plots.pdf") 
# Creating a plot
#plot(chain.SS.351)
#plot(chain.SS.352)
#plot(chain.SS.353)
...
print("AMPfixedSS.350s.comb")
#summary(SS.350s.comb)
#pdf("AMPfixedSS.350s_comb_trace_plot.pdf")
#plot(SS.350s.comb)
#dev.off()

## summary output of comb chain:
#bayou MCMC chain: 2000001 generations
#140073 samples, first 0 samples discarded as burnin
#
#Summary statistics for parameters:
#                            Mean           SD     Naive SE Time-series SE
#lnL                 4.664859e+02 1.863360e+00 4.978741e-03   6.953352e-03
#prior               4.063103e+00 1.462399e+00 3.907408e-03   4.082856e-03
#alpha               5.007990e-04 4.220855e-04 1.127777e-06   1.423043e-06
#sig2                4.368522e-04 2.859874e-05 7.641344e-08   1.097832e-07
#k                   4.000000e+00 0.000000e+00 0.000000e+00   0.000000e+00
#ntheta              5.000000e+00 0.000000e+00 0.000000e+00   0.000000e+00
#root.theta         -1.820487e+00 1.969055e-01 5.261150e-04   6.901236e-04
#root.beta_BodyMass  4.880223e-01 8.634804e-02 2.307147e-04   2.676341e-04
#all theta          -1.685275e+00 3.688107e-01           NA             NA
#all beta_BodyMass   6.056480e-01 1.222280e-01           NA             NA
#                   Effective Size    HPD95Lower    HPD95Upper
#lnL                      71813.33  4.627597e+02  4.695412e+02
#prior                   128293.27  1.123901e+00  6.336346e+00
#alpha                    87976.10  2.689323e-09  1.336563e-03
#sig2                     67861.26  3.821921e-04  4.934948e-04
#k                            0.00  4.000000e+00  4.000000e+00
#ntheta                       0.00  5.000000e+00  5.000000e+00
#root.theta               81407.04 -2.212287e+00 -1.438316e+00
#root.beta_BodyMass      104093.15  3.223482e-01  6.606089e-01
#all theta                      NA            NA            NA
...
#99    1           -1.658011        0.001059357    0.5017645
#161   1           -1.675710        0.001054309    0.4992094
#164   1           -1.639399        0.001059447    0.5011616
#1735  1           -1.632768        0.001025272    0.4994706
...
ss.SS.350s$lnr
## lnr == 448.1355
pdf("AMPfixedSS.350s.comb_ss_plot.pdf")
plot(ss.SS.350s)
dev.off()
print("AMPfixedss.SS.350s")
ss.SS.350s$lnr
currentTime <- Sys.time()
print(currentTime)
