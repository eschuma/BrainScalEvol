...
## SS Model, Hypothesis Electrogenesis
## k = 3 shifts
## mormyroid sb = 97
## gymnotes sb = 164
## synodontid sb = 149
...
fixed.mcmc.SS.351 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.351$model, prior=prior.fixed.SS, startpar=model.fixed.SS.351$startpar, file.dir=getwd(), outname="EGENfixedSS_r351", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.352 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.352$model, prior=prior.fixed.SS, startpar=model.fixed.SS.352$startpar, file.dir=getwd(), outname="EGENfixedSS_r352", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.353 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.353$model, prior=prior.fixed.SS, startpar=model.fixed.SS.353$startpar, file.dir=getwd(), outname="EGENfixedSS_r353", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.354 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.354$model, prior=prior.fixed.SS, startpar=model.fixed.SS.354$startpar, file.dir=getwd(), outname="EGENfixedSS_r354", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.355 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.355$model, prior=prior.fixed.SS, startpar=model.fixed.SS.355$startpar, file.dir=getwd(), outname="EGENfixedSS_r355", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.356 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.356$model, prior=prior.fixed.SS, startpar=model.fixed.SS.356$startpar, file.dir=getwd(), outname="EGENfixedSS_r356", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.357 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.357$model, prior=prior.fixed.SS, startpar=model.fixed.SS.357$startpar, file.dir=getwd(), outname="EGENfixedSS_r357", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.358 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.358$model, prior=prior.fixed.SS, startpar=model.fixed.SS.358$startpar, file.dir=getwd(), outname="EGENfixedSS_r358", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.359 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.359$model, prior=prior.fixed.SS, startpar=model.fixed.SS.359$startpar, file.dir=getwd(), outname="EGENfixedSS_r359", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
fixed.mcmc.SS.360 <- bayou.makeMCMC(tree, dat=BrainMass, pred=as.matrix(BodyMass), SE=BrainSE, model=model.fixed.SS.360$model, prior=prior.fixed.SS, startpar=model.fixed.SS.360$startpar, file.dir=getwd(), outname="EGENfixedSS_r360", plot.freq=NULL, ticker.freq=1000, samp = 100)
...
#pdf("EGENfixedSS.350s_trace_plots.pdf") 
# Creating a plot
#plot(chain.SS.351)
#plot(chain.SS.352)
#plot(chain.SS.353)
...
#print("EGENfixedSS.350s.comb")
#summary(SS.350s.comb)
#pdf("EGENfixedSS.350s_comb_trace_plot.pdf")
#plot(SS.350s.comb)
#dev.off()
...
#lnL                 4.648274e+02 1.776505e+00 4.746909e-03   6.492144e-03
#prior               4.151160e+00 1.282290e+00 3.426342e-03   3.490525e-03
#alpha               4.984461e-04 4.282631e-04 1.144340e-06   1.411894e-06
#sig2                4.389087e-04 2.901344e-05 7.752534e-08   1.095817e-07
#k                   3.000000e+00 0.000000e+00 0.000000e+00   0.000000e+00
#ntheta              4.000000e+00 0.000000e+00 0.000000e+00   0.000000e+00
#root.theta         -1.820255e+00 1.630145e-01 4.355827e-04   4.985222e-04
#root.beta_BodyMass  5.086924e-01 7.356580e-03 1.965715e-05   3.658134e-05
#all theta          -1.692673e+00 3.622182e-01           NA             NA
#all beta_BodyMass   6.221939e-01 1.109590e-01           NA             NA
#                   Effective Size    HPD95Lower    HPD95Upper
#lnL                      74878.41  4.613103e+02  4.676902e+02
#prior                   134955.63  1.598960e+00  6.041623e+00
#alpha                    92006.20  2.502032e-08  1.348150e-03
#sig2                     70100.70  3.828135e-04  4.958133e-04
#k                            0.00  3.000000e+00  3.000000e+00
#ntheta                       0.00  4.000000e+00  4.000000e+00
#root.theta              106926.01 -2.142798e+00 -1.501242e+00
#root.beta_BodyMass       40442.00  4.945152e-01  5.232858e-01
#all theta                      NA            NA            NA
...
#97   1           -1.658495        0.001066240    0.5001709
#149  1           -1.646949        0.001069619    0.4979602
#164  1           -1.644993        0.001058617    0.5000634
...
ss.SS.350s$lnr
## lnr == 447.2129
pdf("EGENfixedSS.350s.comb_ss_plot.pdf")
plot(ss.SS.350s)
dev.off()
print("EGENfixedss.SS.350s")
ss.SS.350s$lnr
currentTime <- Sys.time()
print(currentTime)
